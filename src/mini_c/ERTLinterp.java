...
public class ERTLinterp implements ERTLVisitor {
    ...
    /** interprete a given ERTL program, starting from the "main" function */
    ...
    private void call(String name) {
        ...
        assert f != null; // program well typed
        this.mem.push(0L); // fictive return address
        HashMap<Register, Long> saved_regs = this.mem.regs;
        HashMap<Register, Long> new_regs = new HashMap<>();
        ...
        this.mem.pop(); // pop the fictive return address
    ...
    public void visit(ERmbbranch o) {
        long v1 = get(o.r1);
        long v2 = get(o.r2);
        boolean b = true; // because the compilo Java isn't clever enough
        switch (o.m) {
