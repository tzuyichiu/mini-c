...
public class RTLinterp implements RTLVisitor {
    ...
    /** interprete a given RTL program, starting from the "main" function */
    ...
    private long call(String name, List<Register> rl) {
        ...
        while (!this.next.equals(f.exit)) {
            ...
            if (i == null) 
                throw new Error("no RTL instruction at label " + this.next);
            i.accept(this);
        }
    ...
    public void visit(Rmbinop o) {
        ...
        if (o.m == Mbinop.Mmov)
            ...
            default: assert false; // Mmov already treated
        }
        }
        this.next = o.l;
    }
